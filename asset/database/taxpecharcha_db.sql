...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 11, 2024 at 07:54 AM
...
('manishsuvasiya123', '$2y$10$nPV8dv5IRO8InF8Dp6Py6uaTlerU894PrT0zR8LT/8t9ykAEErlua', '2002-05-08', 'In what city were you born?', 'mumbai');
...
(81, 'sample-blog-4', 'Sample Blog 4', 'The Income Tax Act, 1961', 'Circular / Notification', 'Section 4', 'tax, assessment, penalties', '../../asset/uploads/3156.jpg', 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.', 47, 'C. A. Manish Suvasiya', '2024-07-10 16:58:13'),
...
(84, 'sample-blog-7', 'Sample Blog 7', 'The GST Act, 2017', 'Circular / Notification', 'Section 7', 'gst, place of supply, invoices', '../../asset/uploads/3156.jpg', 'Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 1, 'C. A. Manish Suvasiya', '2024-06-28 16:57:21'),
...
(111, 'sample-blog-34', 'Sample Blog 34', 'The Income Tax Act, 1961', 'Circular / Notification', 'Section 34', 'tax, assessment, penalties', '../../asset/uploads/3156.jpg', 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.', 1, 'C. A. Manish Suvasiya', '2024-06-28 16:57:21'),
...
(127, 'sample-blog-50', 'Sample Blog 50', 'The GST Act, 2017', 'Act', 'Section 50', 'gst, compliance, penalties', '../../asset/uploads/3156.jpg', 'Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 2, 'C. A. Manish Suvasiya', '2024-06-28 16:57:21'),
(146, 'circular-no-210-4-2024-dated-june-26-2024-of-gst', 'Circular No. 210/4/2024 , Dated June 26, 2024 of GST', 'The GST Act, 2017', 'Circular / Notification', 'Circular No. 210/4/2024 , Dated June 26, 2024 of GST', '210/4/2024', '../../asset/uploads/screencapture-technorisen-the-power-of-seo-boosting-organic-traffic-and-increasing-revenue-2024-07-17-15_02_58.png', '<p>Clarification on valuation of supply of import of services by a related person where recipient is eligible to full input tax credit<br><br>Here is the simplest very easy form to understand.<br><br>Clarification is issued regarding rule 28(1) of CGST Rules, covering the cases where the foreign affiliate is providing service to the related domestic entity: <br><br>&bull; A self-invoice is required to be generated under Section 31(3)(f) of CGST Act. <br><br>&bull; Where full input tax credit is available to the same domestic entity, the value of such supply of services declared in the self-invoice by the domestic entity may be deemed as open market value. <br><br>&bull; where full input tax credit is available to the recipient &amp; the invoice is not issued by the related domestic entity then the value of such services may be deemed to be declared as Nil <br><br><br>Stay connected with me for further future updateds.<br><br>Thanks &amp; Regards<br>Manish Suvasiya</p>', 19, 'C. A. Manish Suvasiya', '2024-07-21 12:23:45'),
(152, 'gggg', 'gggg', 'The Income Tax Act, 1961', 'Act', 'gggg', 'gggg', '../../asset/vectors/DefaultBlogImage.svg', '<p>gggg</p>', 49, 'C. A. Manish Suvasiya', '2024-07-21 13:26:38');
